...
class URE_View {
        ...
        <div id="ure_pro_advertisement" style="clear:left;display:block; float: left;">
            <a href="https://www.role-editor.com?utm_source=UserRoleEditor&utm_medium=banner&utm_campaign=Plugins "
               target="_new">
                ...
                ?>
                <img src="<?php echo URE_PLUGIN_URL; ?>images/user-role-editor-pro-728x90.jpg"
                     alt="User Role Editor Pro"
            ...
            <label for="ure_hide_pro_banner">
                <input type="checkbox" name="ure_hide_pro_banner" id="ure_hide_pro_banner"
                       onclick="ure_hide_pro_banner();"/>&nbsp;Thanks, hide this banner.
            </label>
            <?php
            }
            ?>
    ...
    public function display_caps($for_role = true, $edit_mode = true)
    {
        ...
        <table id="ure_caps_container" cellpadding="0" cellspacing="0">
            <tr>
                <td id="ure_caps_groups_title"><span
                        style="font-weight: bold;"><?php esc_html_e('Group', 'user-role-editor'); ?></span>
                ...
                <td id="ure_caps_select">
                    <div class="ure-table">
                        ...
                        <div class="ure-table-cell ure-caps-option nowrap">
                            ...
                            <input type="text" id="quick_filter" name="quick_filter" value="" size="20"
                                   onkeyup="ure_filter_capabilities(this.value);"/>
                        </div>
                        <div class="ure-table-cell ure-caps-option nowrap">
                            <?php esc_html_e('Columns:', 'user-role-editor'); ?>
                            <select id="caps_columns_quant" name="caps_columns_quant"
                                    onchange="ure_change_caps_columns_quant();">
                                <option value="1" <?php echo $this->lib->option_selected(1, $caps_columns_quant); ?> >
                                    1
                                </option>
                                <option value="2" <?php echo $this->lib->option_selected(2, $caps_columns_quant); ?> >
                                    2
                                </option>
                                <option value="3" <?php echo $this->lib->option_selected(3, $caps_columns_quant); ?> >
                                    3
                                </option>
                            </select>
                        </div>
