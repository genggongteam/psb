...
<?php if( $active == 'new' ): ?>
	...
	<div class="feature-section acf-three-col">
		...
		<div>
            ...
            <p><?php printf(__('All 4 premium add-ons have been combined into a new <a href="%s">Pro version of ACF</a>. With both personal and developer licenses available, premium functionality is more affordable and accessible than ever before!', 'acf'), esc_url('https://null24.net')); ?></p>
		</div>
