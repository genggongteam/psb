	...
	<div class="acf-gallery-main">
                ...
                <?php foreach ($value as $i => $v):
                    ...
                    <div class="<?php echo $a['class']; ?>" data-id="<?php echo $a['ID']; ?>">
						...
						<div class="actions acf-soh-target">
                            <a class="acf-icon -cancel dark acf-gallery-remove" href="#"
                               data-id="<?php echo $a['ID']; ?>" title="<?php _e('Remove', 'acf'); ?>"></a>
						</div>
					</div>
				<?php endforeach; ?>
		...
		<div class="acf-gallery-toolbar">
			...
			<ul class="acf-hl">
				<li>
                    <a href="#"
                       class="acf-button button button-primary acf-gallery-add"><?php _e('Add to gallery', 'acf'); ?></a>
				</li>
				<li class="acf-fr">
