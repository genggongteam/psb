            ...
            <section  class="section magee-section section-banner fullheight verticalmiddle" style="background-image: url(<?php echo $image;?>);background-repeat:repeat;">
              <div class="section-content">
                <div class="container">
                  ...
                  <div style="text-align:right"> <a href="<?php echo $btn_link;?>" target="<?php echo $btn_target;?>" class=" magee-btn-normal btn-md btn-line btn-light" id=""><?php echo $btn_text;?></a></div>
                </div>
              </div>
            </section>
          </div>
