...
<div class="printonly">
<img class="onlyprint logo-print" src="<?php echo get_template_directory_uri() . '/img/logo-pzhweb.png'; ?>">
<h4 class="onlyprint title-formulir">FORMULIR PENDAFTARAN SANTRI</h4>
<hr>
<span class="pull-xs-right onlyprint">Nomer Induk: <strong><?php the_field('no_induk_auto'); ?></strong></span>
</div>
...
if(get_field('scl_kelas_masuk'))
{
 ...
 ?>
  ...
  <tr>
    ...
    <td>:</td> 
    <td><?php the_field('alamat_lengkap'); ?><p> <?php the_field('rt_rw'); ?> &nbsp;Kecamatan:&nbsp; <?php the_field('kecamatandistrik'); ?> <br>Kota/Kabupaten:&nbsp;<?php echo get_field('kota_kabupaten')->name;  ?> &nbsp;Propinsi:&nbsp;<?php echo get_field('provinsi')->name; ?> -&nbsp;<?php the_field('warga_negara'); ?></p>
...
<p class="onlyprint">Saya sanggup menjadi santri yang tunduk terhadap segala peraturan yang dikeluarkan oleh Shohibul Bait dan Pengurus Pesantren Zainul Hasan Genggong.</p>
<div class="row onlyprint">
<div class="col-xs-6 text-xs-center">
<strong>Mengetahui,<br>Wali Santri</strong><br><br><br><br><br>
<small class="text-muted">................................<br>Nama Lengkap Wali Santri</small>
</div>
<div class="col-xs-6 text-xs-center">
<strong>Genggong,<?php todayID(); ?><br></strong><br><br><br><br><br>
<small class="text-muted">................................<br>Nama Lengkap Santri</small>
</div>
</div>
